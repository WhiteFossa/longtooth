...
namespace longtooth.Protocol.Abstractions.Responses
{
    public class DownloadFileResponse : ResponseHeader
    {
        ...
        public DownloadFileResponse(DownloadedFileDto file, byte[] fileContent) : base(CommandType.DownloadFile)
        {
            File = file;
        ...
        public static DownloadFileResponse Parse(string header, byte[] payload)
        {
